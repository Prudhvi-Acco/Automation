...
public class LoginTest01 extends Base {
    ...
    public void Login_with_valid_creds () {
        ...
        loginPageObj.$nextBtn.get().click();
        loginPageObj._enterPassword("Kotrakona@1997");
        loginPageObj._displayPassword(true);
        loginPageObj._displayPassword(false);
        loginPageObj.$nextBtn.get().click();
    }
